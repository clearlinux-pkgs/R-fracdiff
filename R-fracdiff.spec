...
%setup -q -n fracdiff
pushd ..
cp -a fracdiff buildavx2
popd
pushd ..
cp -a fracdiff buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737144493
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/fracdiff/libs/fracdiff.so
/V4/usr/lib64/R/library/fracdiff/libs/fracdiff.so
