...
Version  : 1.5.2
Release  : 39
URL      : https://cran.r-project.org/src/contrib/fracdiff_1.5-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fracdiff_1.5-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667332804
